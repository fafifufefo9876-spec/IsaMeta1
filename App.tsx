...
import { Download, Trash2, Wand2, UploadCloud, Aperture, FolderOutput, FilePlus, CheckCircle, AlertCircle, Circle, Database, Activity, Coffee, FolderPlus } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen md:h-screen bg-gray-50 overflow-x-hidden">
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 w-full bg-white border-b border-gray-200 px-6 h-20 flex items-center justify-between shadow-sm z-50">
        <div className="flex items-center gap-3">
          <div className="bg-blue-600 p-2 rounded-lg">
            <Aperture className="text-white w-6 h-6" />
          </div>
          <h1 className="text-4xl font-share-tech font-bold bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-transparent tracking-tight leading-none pt-1">IsaMeta</h1>
        </div>
      ...
      <main className="flex-1 flex flex-col md:flex-row md:overflow-hidden relative pt-20">
